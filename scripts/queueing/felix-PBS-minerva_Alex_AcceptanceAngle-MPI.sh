...
#Name of Job
#-----------
Job_Name=FS_Minerva_test #job name here (FS... or FR...)
...
submitdir=/storage/physics/phrmfk/Minerva_testing

# tmp directory to run felix in
# Doesn't need to exist
bashtmpdir=$HOME/TEMPRUNS/Minerva_testing_temp
...
echo "IMinStrongBeams           = 15"                                         >> $inpfile
